...
[v0.195.0](HTTPS://github.com/microsoft/vscode-dev-containers/tree/v0.195.0/containers/java-8)
...
**Digest:**
sha256:d08b59c8fe52f088ec44fbc00845c97295a46200626779ce193eae9ea7e107ee

**Tags:**

```
mcr.microsoft.com/vscode/devcontainers/java:0.203.0-8-bullseye
mcr.microsoft.com/vscode/devcontainers/java:0.203.0-8-jdk-bullseye
```
...
**Digest:**
sha256:998485855accbd433d9c9b76b59a32f452677f0c86ad970f2e28009fb69f7e7d

**Tags:**

```
mcr.microsoft.com/vscode/devcontainers/java:0.203.0-8-buster
mcr.microsoft.com/vscode/devcontainers/java:0.203.0-8
mcr.microsoft.com/vscode/devcontainers/java:0.203.0-8-jdk-buster
```
