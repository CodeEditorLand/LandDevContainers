...
[v0.241.1](HTTPS://github.com/microsoft/vscode-dev-containers/tree/v0.241.1/containers/rust)
...
**Digest:**
sha256:bcd3fcbb44ac56cba0a7c7b0d4a7cf58d90fd8fe972bf4862988af7eb4ef3f3b

**Tags:**

```
mcr.microsoft.com/vscode/devcontainers/rust:0.202.1-buster
mcr.microsoft.com/vscode/devcontainers/rust:0.202.1-1
mcr.microsoft.com/vscode/devcontainers/rust:0.202.1-1-buster
```
...
```
mcr.microsoft.com/vscode/devcontainers/rust:0.202.1-bullseye
mcr.microsoft.com/vscode/devcontainers/rust:0.202.1-1-bullseye
```
