...
[v0.191.0](HTTPS://github.com/microsoft/vscode-dev-containers/tree/v0.191.0/containers/javascript-node)
...
**Digest:**
sha256:0b056ee2c135cdf5f73a1de7d134a691183e822f9c9ea01a230f36ea063b0c53

**Tags:**

```
mcr.microsoft.com/vscode/devcontainers/javascript-node:0.202.5-16-buster
mcr.microsoft.com/vscode/devcontainers/javascript-node:0.202.5-16
```
...
**Digest:**
sha256:3a7ba6c77517bfcef16474f24539be555919593ee2e1b8805209ccc18ab7530e

**Tags:**

```
mcr.microsoft.com/vscode/devcontainers/javascript-node:0.202.5-14-buster
mcr.microsoft.com/vscode/devcontainers/javascript-node:0.202.5-14
```
...
**Digest:**
sha256:8e30d1bebfa37b2b6fea176b5f3c7a9dd9acb64de7dc0ef733f0711c66d1dd1b

**Tags:**

```
mcr.microsoft.com/vscode/devcontainers/javascript-node:0.202.5-12-buster
mcr.microsoft.com/vscode/devcontainers/javascript-node:0.202.5-12
```
...
**Digest:**
sha256:65290e197cd2855c9a44f1fc59d3db266e39918c95ebaa112b15ac5aa17a9a68

**Tags:**

```
mcr.microsoft.com/vscode/devcontainers/javascript-node:0.202.5-14-stretch
```
...
**Digest:**
sha256:7fa0609019c817cec37455b69292b3de0483fdb7a5c4f53fe314f6cb708eb33c

**Tags:**

```
mcr.microsoft.com/vscode/devcontainers/javascript-node:0.202.5-12-stretch
```
